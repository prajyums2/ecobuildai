...
import { FaArrowRight, FaLeaf, FaRupeeSign, FaCheckCircle, FaChartLine, FaCalculator } from 'react-icons/fa';

function QuantitySurveyView() {
      ...
      <div className="card-body">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h3 className="text-lg font-bold text-foreground">Quantity Survey (QSV)</h3>
...
export default QuantitySurveyView;